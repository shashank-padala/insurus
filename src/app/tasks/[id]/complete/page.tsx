...
export default function CompleteTaskPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/checklists/${task.checklist_id}`);
    } catch (error: any) {
              ...
              {(task.verification_type === "photo" ||
                ...
                <div className="space-y-2">
                  ...
                  {photoPreview ? (
                    ...
                    <label
                      htmlFor="photo"
                      className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-input rounded-lg cursor-pointer hover:bg-muted/50 transition-colors"
                    >
